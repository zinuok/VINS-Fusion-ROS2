...
**(you can echo the published ros2 topic or visualize using Rviz2)**
```
$(PATH_TO_YOUR_ROS_WS)/install/vins/bin/vins_node $(PATH_TO_CONFIG.YAML)

# example
/home/zinuok/ros/catkin_ws/install/vins/bin/vins_node /home/zinuok/ros/catkin_ws/src/vins-fusion-ros2/VINS-Fusion/config/euroc/euroc_stereo_imu_config.yaml
```
